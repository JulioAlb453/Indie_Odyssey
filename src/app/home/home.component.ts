...
export class HomeComponent {
  title: string = 'La Epoca Dorada de los videojuegos indies';
  paragram1: string =
    'En el mercado de los videojuegos estan reinados por juegos triple A o juegos como servicio pero eso no impide que los sectores mas pequeños como son los videojuegos indies cada dia sean mas populares, ya que multitud de gamers se han sentido estancados conlos videojuegos actuales ¿pero por què ahora los gamers se sienten menos ganar de juegar algun videojuego? Esto se debe a la poca innovaccion por parte de las grandes empresas implementan en sus franquicias';
  paragram2: string =
    'Gracias a ello el sector de los juegos independientes ha tenido unagran aceptaciòn por parte del publico por lo innovador y atrevido que estos pueden llegar a ser, o simplemente tiene elementos sencillos pero con mecanicas divertidas, juegos como starwdey valley, hollow knight o dead cells son juegos que tienen una estructura que no es nueva, pero que su forma de jugar estan muy pulidas que evitan caer en un juego mas del monton';
